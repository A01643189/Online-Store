...
export const PostalCodeLookup = ({ onSelect, initialValue = '' }: PostalCodeLookupProps) => {
  ...
  const handleSearch = () => {
    ...
    const neighborhoods = NEIGHBORHOODS[postalCode as keyof typeof NEIGHBORHOODS] as PostalCodeData[];
    ...
    <div className="postal-code-lookup">
      <div className="search-container">
        <input
          ...
          maxLength={5}
        />
        <button type="button" onClick={handleSearch} disabled={postalCode.length !== 5}>
          Search
        </button>
      </div>
